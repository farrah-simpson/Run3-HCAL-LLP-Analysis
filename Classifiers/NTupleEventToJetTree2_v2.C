...
/* ====================================================================================================================== */
void NTupleEventToJetTree2_v2(string infilepath = "", string outfilepath = "" ){
...
//	if( infilepath.find( "Run202") != string::npos ) // For Data
//		SkimEventsMakeJetTree( infilepath, outfilepath, "PassedHLT", true, false );
//	else // For Signal
//		SkimEventsMakeJetTree( infilepath, outfilepath, "PassedHLT", false, true );
...
int main(int argc, char** argv) { // For running in compiled mode
	...
	if( argc > 2 ){
		cout << "heree" << endl;        
		NTupleEventToJetTree2_v2( argv[1], argv[2] );}
